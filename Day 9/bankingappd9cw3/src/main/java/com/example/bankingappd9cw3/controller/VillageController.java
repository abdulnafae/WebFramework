package com.example.bankingappd9cw3.controller;
...
public class VillageController {
    ...
    public VillageController(int villageId, String villageName, int numOfMen, int numOfWomen, int villagePopulation,
            int numOfSchools) {
